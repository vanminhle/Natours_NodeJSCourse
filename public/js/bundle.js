...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmFubWluaGxlIiwiYSI6ImNsMnBqeHl6bDJsOWUzYnA5anV0NW9nZDIifQ._mAL0tbrBygYpw0peUD1vw';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error while logging out. Try again later!');
...
var stripe = Stripe('pk_test_51Kwk2hFSinNEnVrwqV6xGe7Bc7feZ6DhK4WZrXg7xrvikJcSohbm0DcdpP0ZEfP7LJXrCLcSJI9VooivVgHO5EdC002ugP0YbO');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); //MULTIPART FORM DATA BECAUSE WE NOT ONLY HAVE STRING DATA BUT ALSO PHOTO OR FILE
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    e.target.style.backgroundColor = '#000000'; //e.target -  target the click element button
